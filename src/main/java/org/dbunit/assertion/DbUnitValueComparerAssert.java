...
public class DbUnitValueComparerAssert extends DbUnitAssertBase {
     ...
     */
    public void assertWithValueComparer(final IDataSet expectedDataSet, final IDataSet actualDataSet, final ValueComparer defaultValueComparer) throws DatabaseUnitException {
        final Map<String, Map<String, ValueComparer>> tableColumnValueComparers = valueComparerDefaults.getDefaultTableColumnValueComparerMap();
     ...
     *            tables.
     */
    public void assertWithValueComparer(final IDataSet expectedDataSet, final IDataSet actualDataSet, final ValueComparer defaultValueComparer, final Map<String, Map<String, ValueComparer>> tableColumnValueComparers) throws DatabaseUnitException {
        final FailureHandler failureHandler = getDefaultFailureHandler();
        assertWithValueComparer(expectedDataSet, actualDataSet, failureHandler, defaultValueComparer, tableColumnValueComparers);
    }
     ...
     *            {@link ValueComparerDefaults#getDefaultValueComparer()}.
     */
    public void assertWithValueComparer(final ITable expectedTable, final ITable actualTable, final ValueComparer defaultValueComparer) throws DatabaseUnitException {
        final String tableName = expectedTable.getTableMetaData().getTableName();
        final Map<String, ValueComparer> columnValueComparers = valueComparerDefaults.getDefaultColumnValueComparerMapForTable(tableName);
     ...
     *            table.
     */
    public void assertWithValueComparer(final ITable expectedTable, final ITable actualTable, final ValueComparer defaultValueComparer, final Map<String, ValueComparer> columnValueComparers) throws DatabaseUnitException {
        final FailureHandler failureHandler = getDefaultFailureHandler();
     ...
     *            table.
     */
    public void assertWithValueComparer(final ITable expectedTable, final ITable actualTable, final Column[] additionalColumnInfo, final ValueComparer defaultValueComparer, final Map<String, ValueComparer> columnValueComparers) throws DatabaseUnitException {
