...
/**
 * {@link ValueComparator} implementation that verifies actual value is not null.
 * Note, ignores any expected value.
 *
 * @author Jeff Jensen
 * @since 2.7.3
 */
public class IsActualNotNullValueComparer extends AbstractValueComparatorTemplate {
