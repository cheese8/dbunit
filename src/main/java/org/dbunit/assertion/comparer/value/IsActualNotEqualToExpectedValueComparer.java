...
/**
 * {@link ValueComparator} implementation that verifies actual value is not equal
 * to expected value.
 *
 * @author Jeff Jensen
 * @since 2.6.0
 */
public class IsActualNotEqualToExpectedValueComparer extends AbstractValueComparatorTemplate {
    @Override
