...
public class SortedTable extends AbstractTable {
     ...
     * @param table               decorated table
     * @param columns             columns to be used for sorting
     * @param useSpecifiedColumns true to use the column definitions specified by the columns
     ...
     * @param metaData The metadata used to retrieve all columns which in turn are
